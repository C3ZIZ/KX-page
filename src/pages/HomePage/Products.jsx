    ...
    <section className="bg-[#071C2F] w-full  p-14 py-16 relative z-10">
      ...
      <div className="">
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-xl text-[#FA7C0B] [text-shadow:0_0_8px_#FA7C0B,0_0_18px_#FA7C0B]">Products</span>
        </div>
        <div className="">
            ...
            <div className="p-6 pt-20 relative rounded-4xl before:p-0.5! max-w-[380px] border-gradiant-no-bg ">
              <div className="text-white relative z-10!">
                ...
                <h3 className="mt-2 text-3xl font-semibold">
                  Open Research, Connected Futures
                </h3>
              ...
              <div className="bg-[#E98214] p-3.5 border-16 border-white rounded-full w-max absolute -top-1 -right-1 z-100! cursor-pointer">
                <img className="w-6 h-6 hover:translate-x-1 hover:-translate-y-1 transition-all" src={directIcon} alt="" />
              </div>
            </div>
