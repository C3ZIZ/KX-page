// HeroCTA.jsx
// Purpose: Centered hero call-to-action block with headline, subheadlines, and a primary button.
  ...
  return (
    <section dir="ltr" className="relative text-center py-56">
      <div className="mx-auto max-w-4xl">
        <h1 className="text-6xl text-white font-bold">Your Deep-Tech Partner</h1>
